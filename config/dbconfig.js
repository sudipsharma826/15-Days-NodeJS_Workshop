...
module.exports = {
    ...
    // DB: "sudip",              // The name of the database
    // dialect: "mysql",         // The dialect (in this case, MySQL)
    // PORT: 3306,               // The port to connect to the database (default for MySQL is 3306)
    ...
    dialect: "mysql",               // The dialect (in this case, MySQL)
    PORT: process.env.DB_PORT || 3306 // The port to connect to the database (default for MySQL is 3306)
